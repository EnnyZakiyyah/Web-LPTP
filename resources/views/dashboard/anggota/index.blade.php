                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/anggota/{{ auth()->user()->id}}/edit" class="badge bg-warning"><i class="feather icon-edit" style="color: white"></i></a>
                                    <form action="/dashboard/anggota/{{ auth()->user()->id }}" method="POST" class="d-inline">
                                        @method('delete')
                                        @csrf
