                ...
                <div class="col-lg-10">
                    <form method="POST" action="/dashboard/faqs" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                              <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" value="{{ old('name') }}" required autofocus/>
                            @error('name')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                              <input class="form-control @error('pertanyaan') is-invalid @enderror" type="text" name="pertanyaan" id="pertanyaan" value="{{ old('pertanyaan') }}"/>
                            @error('pertanyaan')
                              <div class="invalid-feedback">
                                  {{ $message }}
                              </div>
