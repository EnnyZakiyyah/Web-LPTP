        ...
        <div class="body-section">
            ...
            <table class="table-bordered">
                ...
                <tr>
                    ...
                    <td>{{ $row->name }}</td>
                    <td>{{ $row->katalogs->count('pivot.category_id') }}</td>
                </tr>
                @endforeach
                @endif
            </table>
            ...
            <table class="table-bordered">
                ...
                <tr>
                    <th scope="row">{{ $loop->iteration }}</th>
                    <td>{{ $row->name }}</td>
                    <td>{{ $row->katalogs->count('pivot.label_id') }}</td>
                </tr>
                @endforeach
                @endif
            </table>
            <br>
            <p style="padding-left: 25px; text-align: justify; padding-right:25px;">III. Koleksi Digital</p>
            <br>
            <table class="table-bordered">
                <thead>
                    <tr>
                ...
                <tr>
                    <th scope="row">{{ $loop->iteration }}</th>
                    <td>{{ $row->name }}</td>
                    <td>{{ $row->koleksidigitals->count('pivot.category_id') }}</td>
                </tr>
                @endforeach
                @endif
            </table>
            <br>
            <p style="padding-left: 25px; text-align: justify; padding-right:25px;">IV. Peminjaman Buku</p>
            <br>
            <table class="table-bordered">
                <thead>
                    <tr>
            ...
            <table class="table-bordered">
                ...
                <tr>
                    <th scope="row">{{ $loop->iteration }}</th>
                    {{-- <td>{{ $row->nama }}</td> --}}
                    <td>{{ $row->peminjamans->count('pivot.id_kondisi') }}</td>
                </tr>
                @endforeach
                @endif
            </table>
            <br>
            <p style="padding-left: 25px; text-align: justify; padding-right:25px;">V. Denda</p>
            <br>
            <table class="table-bordered">
                <thead>
                    <tr>
