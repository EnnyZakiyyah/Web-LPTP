        ...
        <div class="body-section">
            ...
            <table class="table-bordered">
              ...
              <tbody style="font-size: 12px">
                  <tr>
                    <th scope="row" >1</th>
                    <td>{{ $unitkerja->count() }}</td>
                </tr>
              </tbody>
            </table>
            <br>
            <p style="padding-left: 25px; text-align: justify; padding-right:25px;">II. Peminjaman</p>
            <br>
    <table class="table-bordered">
        <thead style="font-size: 12px">
          <tr>
        ...
        <tbody style="font-size: 12px">
            ...
            @endforeach
              <tr>
                ...
                <td colspan="2" class="text-right">@currency($denda)</td>
              </tr>
              <tr>
                  <td colspan="8" class="text-right">Jumlah Peminjaman</td>
                  <td>{{ $totalpeminjaman->count() }}</td>
              </tr>
        </tbody>
      </table>
      <br>
