    ...
    <div class="pcoded-content">
        ...
        <div class="card">
            ...
            <div class="card-body table-border-style">
                <div class="col-lg-10">
                    <form method="POST" action="/dashboard/peminjamans" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                              <input class="form-control @error('tgl_kembali') is-invalid @enderror" type="date" name="tgl_kembali" id="tgl_kembali" value="{{ old('tgl_kembali') }}"/>
                            @error('tgl_kembali')
                              <div class="invalid-feedback">
                                  {{ $message }}
                              </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                              <input class="form-control @error('denda') is-invalid @enderror" type="text" name="denda" id="denda" value="{{ old('denda') }}"/>
                            @error('denda')
                              <div class="invalid-feedback">
                                  {{ $message }}
                              </div>
