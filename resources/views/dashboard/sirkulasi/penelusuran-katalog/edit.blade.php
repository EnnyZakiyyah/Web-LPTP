                ...
                <div class="col-lg-10">
                    <form method="POST" action="/dashboard/sirkulasi/katalogs/{{ $katalog->slug }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                          ...
                          <div class="mb-3 row">
                            <label for="label" class="col-md-2 col-form-label">Jenis Label</label>
                            <div class="col-md-10">
                            <select class="form-control" id="label" name="label_id">
                                @foreach ($labels as $label)
                                @if (old('label_id', $katalog->label_id) == $label->id)
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                              <input class="form-control" type="number" name="tahun_terbit" id="tahun_terbit" value="{{ old('tahun_terbit', $katalog->tahun_terbit) }}"/>
                            </div>
                        </div>
                        <div class="mb-3 row">
