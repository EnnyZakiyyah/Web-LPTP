...
@section('container')
<div class="container">
  <h1 class="pt-5 mb-2 fs-7 fw-bold"><span style="color: #002147">Katalog Category : {{ $title }} </span></h1>
            ...
            <div class="col-md-4 mb-4">
              <div class="card" style="background-color: #F9F7F7; border : 1px solid #E5E5E5; "><center><img class="img-thumbnail" src="{{ asset('assets/img/sirkulasi/lord-rings-2.png') }}" alt="..." /></center>
                ...
                <div class="card-body">
                  ...
                  <p>by <a href="/home/sirkulasi/penelusuran-katalog" class="text-primary" style="font-size: 13px;">{{ $katalog->author->name }}</a></p>
