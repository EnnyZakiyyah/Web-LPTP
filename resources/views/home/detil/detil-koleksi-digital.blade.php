                    ...
                    <div class="col-md-4">
                      <div class="card-image">
                        <a href="#"> <img class="img" src="{{ asset('storage/' . $koleksidigital->image) }}">
                          <div class="card-caption px-2 py-1"><a href="/home/sirkulasi/penelusuran-katalog?category={{ $koleksidigital->category->slug }}" class="text-white text-decoration-none"> {{ $koleksidigital->category->name }} </a></div>
                        </a>
                    </div>
                    </div>
