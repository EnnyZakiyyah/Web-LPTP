                        ...
                        <table class="table table-hover">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>:</td>
                              <td style="text-align: justify !important"><a href="/home/sirkulasi/penelusuran-katalog/authors/{{ $katalog->author->username }}" class="text-decoration-none">{{ $katalog->author->name }}</a></td>
                            </tr>
                            <tr>
