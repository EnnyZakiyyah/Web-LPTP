                        ...
                        <table class="table table-hover">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>:</td>
                              <td style="text-align: justify !important"><a href="/home/sirkulasi/penelusuran-katalog?author={{ $katalog->author->slug }}" class="text-decoration-none">{{ $katalog->author->nama }}</a></td>
                            </tr>
                            <tr>
